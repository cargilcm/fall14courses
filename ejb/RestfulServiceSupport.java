...
public class RestfulServiceSupport {
	...
	static String queryWithXMLReturn( String baseURL, String dbQuery, String resultQuery ) throws Exception
	{
		String rtnval = null;
	    ...
	    // query out the zone...
	    rtnval = (String)xpath.evaluate( resultQuery, xmldoc, XPathConstants.STRING);
